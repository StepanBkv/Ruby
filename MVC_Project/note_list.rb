class Note_list
    ...
    def add_note note_list
      ...
      when 'Mebel_list'
        @note_list.push(Mebel.new(note_list))
      when 'Office_list'
        @note_list.push(Office.new(note_list))
      end
    end
    ...
    def change_note note_list
      case self.name
      when "Mebel_list"
        @note_list[@choose_note] = Mebel.new(note_list)
      when "Office_list"
        @note_list[@choose_note] = Office.new(note_list)
      end
    end
